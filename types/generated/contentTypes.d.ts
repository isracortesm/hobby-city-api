...
export interface ApiActivityCollaboratorActivityCollaborator
  ...
  info: {
    displayName: 'ActivityCollaborator';
    pluralName: 'activity-collaborators';
    singularName: 'activity-collaborator';
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiActivityParticipantActivityParticipant
  extends Struct.CollectionTypeSchema {
  collectionName: 'activity_participants';
  info: {
    displayName: 'ActivityParticipant';
    pluralName: 'activity-participants';
    singularName: 'activity-participant';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    statusName: Schema.Attribute.Enumeration<['registered', 'paid']> &
      Schema.Attribute.Required &
...
export interface ApiActivityActivity extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String & Schema.Attribute.Required;
    participantsCount: Schema.Attribute.Integer &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<0>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiCompetitionBatchCompetitionBatch
  extends Struct.CollectionTypeSchema {
  collectionName: 'competition_batches';
  info: {
    displayName: 'CompetitionBatch';
    pluralName: 'competition-batches';
    singularName: 'competition-batch';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    batch: Schema.Attribute.Enumeration<
      ['gold', 'silver', 'bronce', 'commented', 'mention', 'none']
    > &
      Schema.Attribute.Required &
...
export interface ApiCompetitionCategoryCompetitionCategory
  extends Struct.CollectionTypeSchema {
  collectionName: 'competition_categories';
  info: {
    displayName: 'CompetitionCategory';
    pluralName: 'competition-categories';
    singularName: 'competition-category';
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiCompetitionCriteriaCompetitionCriteria
  extends Struct.CollectionTypeSchema {
  collectionName: 'competition_criterias';
  info: {
    displayName: 'CompetitionCriteria';
    pluralName: 'competition-criterias';
    singularName: 'competition-criteria';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    maxPoints: Schema.Attribute.Integer & Schema.Attribute.Required;
    name: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiCompetitionModelCompetitionModel
  ...
  info: {
    displayName: 'CompetitionModel';
    pluralName: 'competition-models';
    singularName: 'competition-model';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiCompetitionResultCompetitionResult
  extends Struct.CollectionTypeSchema {
  collectionName: 'competition_results';
  info: {
    displayName: 'CompetitionResult';
    pluralName: 'competition-results';
    singularName: 'competition-result';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiEventCollaboratorEventCollaborator
  extends Struct.CollectionTypeSchema {
  collectionName: 'event_collaborators';
  info: {
    displayName: 'EventCollaborator';
    pluralName: 'event-collaborators';
    singularName: 'event-collaborator';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    role: Schema.Attribute.Enumeration<['staff', 'expositor']> &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiEventEvent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    participationCount: Schema.Attribute.Integer &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<0>;
    publishedAt: Schema.Attribute.DateTime;
    shortDescription: Schema.Attribute.String & Schema.Attribute.Required;
