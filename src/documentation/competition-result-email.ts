  ...
  paths: {
    '/competition-results/send-result-email': {
      post: {
        ...
        description:
          'Envía un email al participante con los resultados de sus modelos evaluados en la competencia, incluyendo el batch obtenido (con felicitación cuando es gold/silver/bronce) y las evaluaciones agrupadas por juez.',
    ...
    '/competition-results/send-result-emails-to-all': {
      post: {
        ...
        description:
          'Envía un email a cada participante con resultados en la competencia, incluyendo únicamente sus modelos evaluados y sus evaluaciones agrupadas por juez.',
